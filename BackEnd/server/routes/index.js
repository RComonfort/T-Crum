...
module.exports = (app) => {
  ...
  app.get('/api/reviewsByPassenger/:passenger_id', reviewsController.listReviewsByPassenger);
  ...
  app.put('/api/arrivals/:id', arrivalsController.update);
  app.delete('/api/arrivals/:id', arrivalsController.destroy);
};